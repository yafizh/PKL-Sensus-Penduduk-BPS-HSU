...
if (isset($_GET['id'])) {
  $sql = "SELECT * FROM kedatangan WHERE id=" . $_GET['id'];
  $result = $mysqli->query($sql);
  $row = $result->fetch_assoc();
} else
  echo "<script>" .
    "window.location.href='kedatangan.php';" .
    "</script>";
...
if (isset($_POST['submit'])) {
  ...
  if ($mysqli->query($sql) === TRUE) {
    echo "<script>alert('Data Kedatangan berhasil diedit.');window.location.href='kedatangan.php';</script>";
      ...
      <div class="tile">
        <div class="tile-body">
          <div class="page-header">
            <div class="row">
              <div class="col">
                <h2 class="mb-3" id="buttons">Edit Data Kedatangan</h2>
              </div>
            </div>
          </div>
          <hr>
